...
public static class ProgramUI
{
    ...
    private static async Task TitleAnimation(CancellationToken stopToken)
    {
        ...
        int colorIndex = RandomNumberGenerator.GetInt32(100);
    ...
    public static void RegisterScreen()
    {
        ...
        while (true)
        {
            ...
            {
                CursorTop = CursorPos.TitleScreenMenuTop;
                WriteLine(" -- Account Registration:");
    ...
    public static bool DeleteAccountScreen()
    {
        ...
        while (true)
        {
            ...
            lock (ConsoleLock)
            {
                ...
                WriteLine(" Uploaded data will be lost.");
    ...
    public static void VictoryScreen(TimeSpan elapsedTime, List<string> options, bool online)
    {
        Clear();
        DrawHeader();
        WriteLine();
